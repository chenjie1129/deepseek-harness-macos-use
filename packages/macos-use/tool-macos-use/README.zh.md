...
驱动模型会看到生成的 [`computer_*`、`browser_*`、`computer_use_task` 与 `browser_use_task` schema](../../../docs/tool-catalog.md#deepseek-aidsh-tool-macos-use)。GUI 提供方端点与凭据属于部署设置，不是模型参数。
